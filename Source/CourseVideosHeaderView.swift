...
class CourseVideosHeaderView: UIView {
    ...
    private var subTitle: String {
        switch state {
        case .partial:
            return Strings.bulkDownloadVideosSubTitle(count: "\(bulkDownloadHelper.partialAndNewVideosCount)")(bulkDownloadHelper.partialAndNewVideosCount)
        case .downloading:
            return Strings.allDownloadingVideosSubTitle(remainingVideosCount: "\(bulkDownloadHelper.partialAndNewVideosCount)")
        default:
            return Strings.bulkDownloadVideosSubTitle(count: "\(videos.count)")(videos.count)
        }
    }
